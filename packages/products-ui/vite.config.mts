...
export default defineConfig(() => ({
  ...
  cacheDir: '../../node_modules/.vite/packages/products-ui',
  plugins: [
    react(),
  ...
  resolve: {
    alias: {
      ...
      '@card-component-demo/shared-ui': path.resolve(import.meta.dirname, '../shared-ui/src'),
  ...
  build: {
    ...
    lib: {
      ...
      entry: 'src/index.ts',
      name: '@card-component-demo/products-ui',
      fileName: 'index',
